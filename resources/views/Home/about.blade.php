...
<footer class="aboutfoot">
        <div class="div1">
            <div class="menu">
                ...
                <div class="menuctnt">
                    <div class="div">
                        <a class="btn" data-bs-toggle="modal" href="#exampleModalToggle" role="button"><i class="fas fa-history"></i> Historique</a>
                    </div>
                    <div class="div">
        ...
        <div class="div2">
            <div class="contact">
               ...
               <ul>
                    ...
                    <li class="li"><i class="fas fa-phone-square"></i><b> 034 44 400 22</b></li>
                    <li class="li"><i class="fas fa-phone-square"></i><b class="b"> Avaradoha en face arrêt 23</b></li>
               </ul>
