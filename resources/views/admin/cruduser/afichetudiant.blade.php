                        ...
                        <div class="card border border-light-subtle rounded-4">
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-5 Affiche">
                                            <div class="p"><img id="imagePreview" src="{{ asset($etudiant->Image) }}" alt="Image par défaut" style="width: 40px; height: 40px;"></div>
                                            <div class="col-12">
                                                <div class="affichenom">
                                                    <input type="text" value="{{$etudiant->name}}" class="form-control" name="name" id="name"  >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form action="" method="post">
                                    @csrf
                                    <input type="hidden" name="user_id" value="{{$etudiant->id}}">
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <a class="btn bsb-btn-xl btn-primary py-3" href="{{ route('admin.listeEtudiant') }}">Retour</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
