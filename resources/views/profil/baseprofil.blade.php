...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body class="bg-light">
        <nav class="navbar navbar-expand-md bg-white shadow-lg bsb-navbar bsb-navbar-hover bsb-navbar-caret">
            <div class="userlogo" style="margin: auto;">
                <img class="lg" src="icon/2D.png" alt="logo" style="width: 80px; height:100px;">
            </div>
            <div class="container">

                <div class="navbar-brand">
                    <div class="userimg">
                        <img src="{{ asset(Auth::User()->profile) }}" alt="image" style="width: 40px; height:40px; border-radius: 100%;">
                    </div>
                    <div class="usernom">
                         <b>{{ Auth::User()->name}}</b>
                    </div>
